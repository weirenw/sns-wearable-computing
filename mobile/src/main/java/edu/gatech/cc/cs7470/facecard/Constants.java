...
public class Constants {
    ...
    public static final String PACKAGE_NAME = "edu.gatech.cc.cs7470.facecard";    public static final int REQUEST_ENABLE_BT = 1; //callback code for bluetooth enabling dialog
    ...
    //TODO: change url
    public static final String REGISTER_ACCOUNT_URL = "http://ec2-54-68-110-119.us-west-2.compute.amazonaws.com/facecard/";
}
